-- =====================================================
-- FIX: update_transaction_atomic v5 (FULL FIFO INTEGRATION)
-- Mengembalikan stok barang lama, lalu memotong stok barang baru
-- Beserta penguncian edit agar tidak merusak data yang sudah dikirim (Delivery)
-- =====================================================
