...
*   **Lock Menu Feature**: Penambahan fitur "Lock Expand" (ikon gembok) di sidebar untuk menjaga semua sub-menu tetap terbuka. State fitur ini disimpan di `localStorage`.
